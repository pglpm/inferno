...
\end{center}
\newcommand{\citebi}{\citep}
\newcommand{\citein}{\citep}
\newcommand*{\subtitleproc}[1]{}
\newcommand*{\chapb}{ch.}

Despite the \emph{intrinsic} flaws of $p$-values and frequentist statistics, many researchers in important areas such as medicine still use them today, instead of using coherent Bayesian methods. And among Bayesian practitioners, many still use parametric methods, which make statistical assumptions that may be unrealistic.
