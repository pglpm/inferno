...
%% Last-Updated: 2026-06-23T20:51:03+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
{\Large An algorithm for non-parametric Bayesian inference}% 
}% title uses LARGE; set Large for smaller
\newcommand*{\pdftitle}{\propertitle}
\newcommand*{\headtitle}{Non-parametric Bayesian inference}
\newcommand*{\pdfauthor}{P.G.L.  Porta Mana}
\newcommand*{\headauthor}{Porta Mana}
\newcommand*{\reporthead}{\ifarxiv\else Zenodo \href{https://doi.org/10.5281/zenodo.***}{\textsc{doi}:10.5281/zenodo.***}\fi}% Report number
...
\footnotesize\quad\epost{\email{pgl}{portamana.org}}%
}%
%% uncomment if additional authors present
% \hspace*{\stretch{1}}%
% \parbox{0.5\linewidth}%\makebox[0pt][c]%
...
\newcommand*{\ptext}[1]{\enquote*{\text{\small #1}}}% for propositions
