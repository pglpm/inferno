...
%% Last-Updated: 2025-06-06T08:10:48+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
F \corr (w^{c},\, r^{c},\, q^{c},\,
  ...
  \nu^{c}, \tau^{c}) \ ,
\end{equation}
and the density $\p(F  \| D,I) \di F$ takes on the more explicit expression shown in \eqn~\eqref{eq:posterior_F_explicit}.
