...
## [outputdir]/plotsamples_learned.pdf
## [outputdir]/plotquantiles_learned.pdf
...
for (i in testpoints) {
  ...
  posterior <- samplesFDistribution(Y = Y, X = X, learned = outputdir, silent = TRUE, parallel = TRUE)
