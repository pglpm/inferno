...
## [outputdir]/plotsamples_learnt.pdf
## [outputdir]/plotquantiles_learnt.pdf
...
for (i in testpoints) {
  ...
  posterior <- samplesFDistribution(Y = Y, X = X, learnt = outputdir, silent = TRUE, parallel = TRUE)
