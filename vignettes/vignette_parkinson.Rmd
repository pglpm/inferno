...
```{r}
plotquantiles(x = 25:80, y = probDecreaseAge$quantiles[1,,],
    ylim = c(0, NA),
    xlab = 'age', ylab = 'probability of MDS-UPDRS-III decr.', col = 1)

plotquantiles(x = 25:80, y = probDecreaseAgePlacebo$quantiles[1,,],
    col = 2, add = TRUE)
...
plotquantiles(x = (-30):30, y = probabilitiesMale$quantiles[,1,],
    ylim = c(0, NA),
    xlab = 'MDS-UPDRS-III difference', ylab = 'probability', col = 5)

plotquantiles(x = (-30):30, y = probabilitiesMale$quantiles[,2,],
    col = 6, add = TRUE)
...
plotquantiles(x = 25:80, y = probMaleDecreaseAge$quantiles[1,,],
    ylim = c(0, NA),
    xlab = 'age', ylab = 'probability of MDS-UPDRS-III decr.', col = 5)

plotquantiles(x = 25:80, y = probMaleDecreaseAgePlacebo$quantiles[1,,],
    col = 6, add = TRUE)
