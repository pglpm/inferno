...
The function for this is `Pr(X, Y, learnt)`, which accepts three arguments:
...
- However, it is also clear that further clinical trials could lead to a quite different probability distribution. This is clear from the breadth of the quantile range.
