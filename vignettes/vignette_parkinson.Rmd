...
To preliminarily answer this question, we can find the analogous probability for a female patient that has not received the treatment. Again we use `tailPr()`, but our `X` argument will specify a `Placebo` value for the Treatment group:
```{r}
