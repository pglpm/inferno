...
The output below was obtained from running `learn()` on 15 cores -- *please wait before running this code*, it might take longer time on your computer:
...
learnt10 <- learn(
    ...
    seed = 16,
    parallel = 15 # number of cores to be used for the computation
    )
## 
...
##  penguin_inference-251231T135959-vrt8_dat10_smp3600 
##  **************************************************** 
...
## Sampling. Core 15 estimated end time: 2025-12-31 14:02   
## Finished Monte Carlo sampling.                                 
## 
## Highest number of Monte Carlo iterations across chains: 3600 
## Highest number of used mixture components: 9 
## 
## Checking test data
## ( #1 #3 #4 #5 #6 #7 #8 #9 #10 )
## 
## rel. MC standard error: min: 0.017  max: 0.043  mean: 0.024 
## eff. sample size: min: 530  max: 3500  mean: 2100 
## needed thinning: min: 2  max: 11  mean: 3.8 
## average: min: 2.3e-08  max: 0.12  mean: 0.014 
## 
## Plotting final Monte Carlo traces and marginal samples...
## 
## Total computation time: 2.5 mins 
## Average total time per chain: 0.042 mins 
## 
...
<div class="figure">
<img src="figure/vis10-1.png" alt="**Estimates and uncertainty of relative frequencies of the three penguin species**" width="100%" />
<p class="caption">**Estimates and uncertainty of relative frequencies of the three penguin species**</p>
</div>
...
##            
## Y               5.5%    94.5%
##   Adelie    0.134878 0.525858
##   Chinstrap 0.132087 0.521080
##   Gentoo    0.180867 0.587441
```
...
<div class="figure">
<img src="figure/hist10-1.png" alt="**Probability distribution for the rel. requencies of the three species**" width="100%" />
<p class="caption">**Probability distribution for the rel. requencies of the three species**</p>
</div>
...
##            X
## Y             Biscoe    Dream
##   Adelie    0.206363 0.324319
##   Chinstrap 0.216615 0.435069
##   Gentoo    0.577022 0.240612
```
...
##            
## Y                5.5%    94.5%
##   Adelie    0.0394491 0.464029
##   Chinstrap 0.0403562 0.476787
##   Gentoo    0.2836580 0.842869
## 
## , , X = Dream
## 
##            
## Y                5.5%    94.5%
##   Adelie    0.0976963 0.608251
##   Chinstrap 0.1722795 0.731138
##   Gentoo    0.0553519 0.500199
```
...
##  *************************************************** 
##  Saving output in directory
##  penguin_inference-251231T145959-vrt8_dat60_smp3600 
##  *************************************************** 
## Starting Monte Carlo sampling of 3600 samples by 60 chains
...
## Estimating remaining time, please be patient...
## Sampling. Core 1 estimated end time: 2025-12-31 15:09   
## Finished Monte Carlo sampling.                                 
## 
## Highest number of Monte Carlo iterations across chains: 13146 
## Highest number of used mixture components: 19 
## 
## Checking test data
## ( #8 #15 #20 #27 #30 #33 #43 #46 #59 )
## 
## rel. MC standard error: min: 0.024  max: 0.057  mean: 0.034 
## eff. sample size: min: 310  max: 1800  mean: 1100 
## needed thinning: min: 4  max: 18  mean: 7 
## average: min: 4.5e-09  max: 1.1e-07  mean: 2.9e-08 
## 
## Plotting final Monte Carlo traces and marginal samples...
## 
## Total computation time: 6.4 mins 
## Average total time per chain: 0.11 mins 
## 
## Removing temporary output files.
## Finished.
## 
...
The calculation, with 60 sample data, took between 5 and 10 minutes to completeon 15 cores.
...
##            
## Y               5.5%    94.5%
##   Adelie    0.294324 0.489339
##   Chinstrap 0.138787 0.300202
##   Gentoo    0.297726 0.495261
```
...
<div class="figure">
<img src="figure/histbiscoe-1.png" alt="**Probability distribution for species frequencies on Biscoe**" width="100%" />
<p class="caption">**Probability distribution for species frequencies on Biscoe**</p>
</div>
...
<div class="figure">
<img src="figure/histdream-1.png" alt="**Probability distribution for species frequencies on Biscoe**" width="100%" />
<p class="caption">**Probability distribution for species frequencies on Biscoe**</p>
</div>
