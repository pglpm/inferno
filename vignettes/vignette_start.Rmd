...
# Highest number of Monte Carlo iterations across chains: 118800 
...
# 
# 
# rel. CI error: 0.0327 to 0.314
# ESS: 2860 to 3650
# needed thinning: 3.85 to 354
# average: 1.96e-08 to 0.187
# width: 5.13e-08 to 0.334
# Plotting final Monte Carlo traces and marginal samples...
# 
# Total computation time: 5.9 mins 
# Average preparation & finalization time: 42 secs 
# Average Monte Carlo time per chain: 4.3 mins 
...
For instance, the plot indicates that there's a 50% probability that the relative frequency of all `Adelie` penguins is roughly between 0.21 and 0.37; and an 89% probability that their relative frequency is roughly between 0.12 and 0.50.

For the `Gentoo` species, there's a 50% probability that its relative frequency is roughly between 0.30 and 0.50; and an 89% probability that their relative frequency is roughly between 0.19 and 0.62.
...
#            
# Y               5.5%    94.5%
#   Adelie    0.119033 0.500842
#   Chinstrap 0.126128 0.519078
#   Gentoo    0.191362 0.623080
```
...
> 
> Adélie
> : rel. frequency between 0.12 and 0.50, with 89% probability.
> 
> Chinstrap
...
#                        5.5% 94.5%
# Adelie,female    0.16 0.049  0.33
# Chinstrap,female 0.13 0.038  0.27
# Gentoo,female    0.29 0.120  0.51
# Adelie,male      0.13 0.036  0.27
# Chinstrap,male   0.17 0.052  0.34
# Gentoo,male      0.11 0.022  0.24
```
...
#            X
# Y             Biscoe    Dream
#   Adelie    0.141728 0.359619
#   Chinstrap 0.139355 0.472755
#   Gentoo    0.718917 0.167626
```
...
#   Adelie             0.13         0.40             0.47        0.20       0.33
#   Chinstrap          0.11         0.40             0.27        0.23       0.54
#   Gentoo             0.76         0.21             0.26        0.57       0.14
#            X
# Y           Torgersen,male
#   Adelie              0.44
#   Chinstrap           0.38
...
# Core 3 finished.                                        
# Finished Monte Carlo sampling.                                 
# Highest number of Monte Carlo iterations across chains: 19479 
...
# 
# 
# rel. CI error: 0.0438 to 0.485
# ESS: 897 to 3480
# needed thinning: 6.92 to 846
# average: 1.79e-09 to 4.75e-08
# width: 2.04e-09 to 1.05e-07
# Plotting final Monte Carlo traces and marginal samples...
# 
# Total computation time: 4.2 mins 
# Average preparation & finalization time: 59 secs 
# Average Monte Carlo time per chain: 2.2 mins 
# Max total memory used: approx 3200 MB
...
The calculation with 60 sample data took around 3 GB and 4 minutes on 4 cores.
...
> From a sample of 60 penguins, the difference between the frequencies of `Gentoo` species and `Chinstrap` species, on `Biscoe` island, is estimated with a median of 0.7, and it is between 0.53 and 0.83 with 89% probability.
...
> From a sample of 60 penguins, the ratio between the frequencies of `Gentoo` species on `Chinstrap` species, on `Biscoe` island, is estimated with a median of 21, and it is between 6.45 and 96.88 with 89% probability.

It is remarkable that with only 60 penguins -- and not all of them from Biscoe island -- we can conclude with a high probability (95%) that there are at least 6 times more Gentoo penguins than Chinstrap penguins on Biscoe island! Note an important consequence from the point of view of hypothesis testing:
...
# 
# 
# rel. CI error: 0.0229 to 0.245
# ESS: 695 to 3570
# needed thinning: 1.88 to 216
# average: 9.22e-11 to 1.75e-07
# width: 1.87e-10 to 1.97e-07
# Plotting final Monte Carlo traces and marginal samples...
# 
# Total computation time: 2.2 hours 
# Average preparation & finalization time: 2.1 mins 
# Average Monte Carlo time per chain: 37 mins 
...
The calculation with 344 sample data took around 4 GB and 2 hours on 4 cores.
...
#            
# Y               5.5%    94.5%
#   Adelie    0.399556 0.484368
#   Chinstrap 0.166470 0.234340
#   Gentoo    0.317716 0.399708
```
...
#            
# Y                 5.5%     94.5%
#   Adelie    0.21546186 0.3248726
#   Chinstrap 0.00272931 0.0268053
#   Gentoo    0.66137535 0.7737580
```
...
#            
# Y               5.5%    94.5%
#   Biscoe    0.235280 0.351853
#   Dream     0.308163 0.429468
#   Torgersen 0.278472 0.399524
```
