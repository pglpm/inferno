...
> 
> Adélie
> : rel. frequency between 0.143 and 0.53, with 89% probability
> 
> Chinstrap
...
### Interlude: differences from "null-hypothesis testing" and *p*-value-based methods
...
``` r
# # select only Biscoe
onlyBiscoe <- subset(Fspecies30I, list(island = 'Biscoe'))

hist(onlyBiscoe, xlim = c(0, 1), legend = 'topright', col = 2:4)
```

<div class="figure">
<img src="figure/hist30biscoe-1.png" alt="**Probability distribution for species frequencies on Biscoe**" width="100%" />
<p class="caption">**Probability distribution for species frequencies on Biscoe**</p>
</div>
...
``` r
# # select only Dream
onlyDream <- subset(Fspecies30I, list(island = 'Dream'))

hist(onlyDream, xlim = c(0, 1), legend = 'topright', col = 2:4)
```

<div class="figure">
<img src="figure/hist30dream-1.png" alt="**Probability distribution for species frequencies on Biscoe**" width="100%" />
<p class="caption">**Probability distribution for species frequencies on Biscoe**</p>
</div>
...
``` r
# # select only Biscoe
onlyBiscoe <- subset(Fspecies100I, list(island = 'Biscoe'))

hist(onlyBiscoe, xlim = c(0, 1), legend = 'topright', col = 2:4)
```

<div class="figure">
<img src="figure/hist100biscoe-1.png" alt="**Probability distribution for species frequencies on Biscoe**" width="100%" />
<p class="caption">**Probability distribution for species frequencies on Biscoe**</p>
</div>
...
``` r
# # select only Dream
onlyDream <- subset(Fspecies100I, list(island = 'Dream'))

hist(onlyDream, xlim = c(0, 1), legend = 'topright', col = 2:4)
```

<div class="figure">
<img src="figure/hist100dream-1.png" alt="**Probability distribution for species frequencies on Biscoe**" width="100%" />
<p class="caption">**Probability distribution for species frequencies on Biscoe**</p>
</div>
