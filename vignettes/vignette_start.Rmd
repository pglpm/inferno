...
# 
# 
# rel. CI error: 0.0339 to 0.271
# ESS: 2770 to 3650
# needed thinning: 4.11 to 262
# average: 2.15e-08 to 0.183
# width: 4.96e-08 to 0.329
# Plotting final Monte Carlo traces and marginal samples...
# 
# Total computation time: 7.4 mins 
# Average preparation & finalization time: 1.1 mins 
# Average Monte Carlo time per chain: 5.9 mins 
...
For the `Gentoo` species, there's a 50% probability that its relative frequency is roughly between 0.30 and 0.49; and an 89% probability that their relative frequency is roughly between 0.20 and 0.61.
...
#            
# Y               5.5%    94.5%
#   Adelie    0.121211 0.505162
#   Chinstrap 0.130026 0.512442
#   Gentoo    0.197827 0.614831
```
...
> 
> Gentoo
> : rel. frequency between 0.20 and 0.61, with 89% probability.
...
#                        5.5% 94.5%
# Adelie,female    0.16 0.050  0.32
# Chinstrap,female 0.13 0.037  0.28
# Gentoo,female    0.29 0.120  0.49
# Adelie,male      0.13 0.037  0.28
# Chinstrap,male   0.17 0.058  0.34
# Gentoo,male      0.11 0.023  0.24
```
...
#            X
# Y             Biscoe    Dream
#   Adelie    0.147855 0.356819
#   Chinstrap 0.141276 0.474088
#   Gentoo    0.710869 0.169093
```
...
#   Chinstrap          0.12         0.40             0.27        0.22       0.54
#   Gentoo             0.75         0.21             0.25        0.57       0.14
#            X
# Y           Torgersen,male
#   Adelie              0.44
#   Chinstrap           0.38
...
# Core 4 finished.                                        
# Finished Monte Carlo sampling.                                 
# Highest number of Monte Carlo iterations across chains: 44407 
# Highest number of used mixture components: 6 
# 
# Checking test data
# ( #8 #15 #17 #20 #27 #30 #33 #42 #43 #46 #55 #59 )
# 
# 
# rel. CI error: 0.0343 to 0.273
# ESS: 1620 to 3510
# needed thinning: 4.18 to 265
# average: 2.21e-09 to 5.4e-08
# width: 1.85e-09 to 1.02e-07
# Plotting final Monte Carlo traces and marginal samples...
# 
# Total computation time: 9.6 mins 
# Average preparation & finalization time: 1.3 mins 
# Average Monte Carlo time per chain: 3.8 mins 
# Max total memory used: approx 3200 MB
# Max memory used per core: approx 810 MB
# Finished.
# 
# Closing connections to cores.
```
...
> From a sample of 60 penguins, the ratio between the frequencies of `Gentoo` species on `Chinstrap` species, on `Biscoe` island, is estimated with a median of 21, and it is between 6.76 and 93.73 with 89% probability.
...
# Core 1 finished.                                        
# Finished Monte Carlo sampling.                                 
# Highest number of Monte Carlo iterations across chains: 16994 
...
# 
# 
# rel. CI error: 0.0278 to 0.242
# ESS: 67.6 to 3480
# needed thinning: 2.78 to 211
# average: 9.51e-11 to 1.76e-07
# width: 1.92e-10 to 1.97e-07
# Plotting final Monte Carlo traces and marginal samples...
# 
# Total computation time: 15 mins 
# Average preparation & finalization time: 2.6 mins 
# Average Monte Carlo time per chain: 7.6 mins 
# Max total memory used: approx 3400 MB
# Max memory used per core: approx 850 MB
# Finished.
# 
# Closing connections to cores.
```

The calculation with 344 sample data took around 3 GB and 15 minutes on 4 cores.
...
#            
# Y               5.5%    94.5%
#   Adelie    0.399997 0.485637
#   Chinstrap 0.164577 0.233579
#   Gentoo    0.318540 0.401157
```
...
> Chinstrap
> : estimate 0.20
>  <br>true rel. frequency between 0.16 and 0.23 with 89% probability.
> 
> Gentoo
> : estimate 0.36
...
#            
# Y                 5.5%     94.5%
#   Adelie    0.21290516 0.3215401
#   Chinstrap 0.00284543 0.0271474
#   Gentoo    0.66560378 0.7751243
```
...
> Gentoo
> : estimate 0.72
>  <br>true rel. frequency between 0.67 and 0.78 with 89% probability.
...
#            
# Y               5.5%    94.5%
#   Biscoe    0.235413 0.354091
#   Dream     0.308993 0.431398
#   Torgersen 0.278241 0.400475
```
