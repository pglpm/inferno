...
quantile(freqdiff, c(0.05, 0.95))
#       5%      95% 
# 0.387664 0.755933
```

> From a sample of 60 penguins, the difference between the frequencies of `Gentoo` species and `Chinstrap` species, on `Biscoe` island, is estimated with a median of 0.59, and it is between 0.39 and 0.76 with 90% probability.
