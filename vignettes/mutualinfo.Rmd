...
with integrals replacing the sums in the case of continuous variates. It is measured in *shannons* (symbol $\mathrm{Sh}$), or *hartleys* (symbol $\mathrm{Hart}$), or *natural units* (symbol $\mathrm{nat}$). These units and other properties of the mutual information are [standardized by the International Organization for Standardization (ISO) and the International Electrotechnical Commission (IEC)](https://archive.org/details/iso-standards-collection/BS%20EN%2080000-13-2008%20-%201%20Quantities%20and%20units).
