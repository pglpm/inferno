...
For example let's calculate the mutual information between the variates `island` and `species`, [previously discussed and visualized](#newsamples):
...
<div class="figure">
<img src="figure/gensamplesplotbodymassspeciesbis-1.png" alt="**Scatter plot for body mass and species**" width="100%" />
<p class="caption">**Scatter plot for body mass and species**</p>
</div>
...
<div class="figure">
<img src="figure/gensamplesplotbodymassbilllenbis-1.png" alt="**Scatter plot for body mass and bill length**" width="100%" />
<p class="caption">**Scatter plot for body mass and bill length**</p>
</div>
...
The subpopulation is chosen with the parameter `X`, as in the `Pr()` and `rPr()` functions. Let's calculate the mutual information between `body_mass` and `bill_len` within each penguin species:
