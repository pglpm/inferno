...
We generate 2000 whole-population samples of the two variates with `rPr()`, and then scatter-plot them with `flexiplot()`:
...
flexiplot(x = samples$body_mass, y = samples$species,
    ...
    ydomain = speciesvalues)
```

<div class="figure">
<img src="figure/gensamplesplotbodymassspecies-1.png" alt="**Scatter plot for whole population**" width="100%" />
<p class="caption">**Scatter plot for whole population**</p>
</div>
...
<div class="figure">
<img src="figure/gensamplesplotbodybilllen-1.png" alt="**Scatter plot for whole population**" width="100%" />
<p class="caption">**Scatter plot for whole population**</p>
</div>
