...
Some trusted colleagues thus go to the three islands, and examine samples of penguins there, sending back the values they observe. The way sampling is done would require a deep analysis and discussion, but for the moment we put these aside.
...
And with these datapoints we start our Bayesian nonparametric analysis using ***inferno***!
