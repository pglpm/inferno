...
- `$MI`: a vector of two numbers: `value` is the value of the mutual information in shannons; `error` is the numerical error in this value (coming from the Monte Carlo calculation).
- 
