...
and can be read from the `values` element of the `Fspecies10` object, either directly or by using the `print()` function, which by default shows two significant digits:
