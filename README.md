...
If you have other questions about application, theory, technical implementation, feel free to contact Luca <pgl@portamana.org>.
...
### Desktop Application
* Download and install the desktop application for Windows or MacOS by following this guide: [Inferno App Windows Release](https://github.com/h587916/Inferno-App/releases/tag/1.0.0).
