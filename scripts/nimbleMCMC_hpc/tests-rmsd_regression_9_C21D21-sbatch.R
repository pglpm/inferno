...
## Last-Updated: 2021-10-24T11:35:34+0200
################
...
seed <- 149
baseversion <- 'TESTregrC21D21_A_'
nclusters <- as.integer(2^2)
ndata <- as.integer(2^3) # nSamples = 37969
niter <- as.integer(2^7)
niter0 <- as.integer(2^7)
nstages <- as.integer(0)
