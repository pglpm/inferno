...
## Last-Updated: 2021-09-29T10:05:15+0200
################
...
alldata2 <- fread('../data_processed_transformed_rescaled.csv', sep=' ')
alldatas <- fread('../rmsd_values_featurized_without_bad_pairs.csv', sep=',')
