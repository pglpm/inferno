...
for(acov in colnames(moms$means)){
    matplot(moms$means[,acov], type='l', lty=1, col=palette()[2], main=acov, ylab=acov)
    }
for(acov in colnames(moms$covars)){
    matplot(moms$covars[,acov], type='l', lty=1, col=palette()[2], main=acov, ylab=acov)
    }
...
pdff(paste0('_test_tracemomentstraces'))
for(acov in colnames(momentstraces$means)){
    matplot(momentstraces$means[,acov], type='l', lty=1, col=palette()[1], main=paste0('distr. mean ', acov), ylab=paste0('distr. mean ', acov))
    }
for(acov in colnames(momentstraces$covars)){
    matplot(momentstraces$covars[,acov], type='l', lty=1, col=palette()[3], main=paste0('distr. covar. ', acov), ylab=paste0('distr. covar. ', acov))
    }
dev.off()
