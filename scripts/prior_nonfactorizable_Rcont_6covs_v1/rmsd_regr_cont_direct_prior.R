...
## Last-Updated: 2021-08-23T15:13:36+0200
################
...
for(case in directcases){
    ...
    ##     nCategories=apply(data[,..discreteCovs],2,function(x)max((x),na.rm=T)),
...
##
save.image(file=paste0('_test_unfactor_cont_model_N',ndata,'_',length(covNums),'covs.RData'))
##
## Diagnostic plots
pdff('mcsummary')
