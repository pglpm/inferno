...
## Last-Updated: 2022-12-29T14:09:33+0100
################
...
outputdir <- 'inferencep4reducedinv'
extratitle <- 'patients'
## totsamples <- 4096L
datafile <- 'ingrid_data_nogds6.csv'
exampledatafile <- 'traindataset.csv'
...
## > sum(resultsgen)/nrow(datanewpatients)
## [1] 0.700831
## > sum(resultsdiscr)/nrow(datanewpatients)
## [1] 0.612188
## >
## > sum(datanewpatients$Subgroup_num_==1)/nrow(datanewpatients)
## [1] 0.299169

## > 1-sum(datanewpatients$Subgroup_num_==1)/nrow(datanewpatients)
## [1] 0.700831
