...
## Last-Updated: 2021-08-24T08:32:57+0200
################
...
##
save.image(file=paste0('_test_parttrain_unfactor_cont_model_N',ndata,'_',length(covNums),'covs.RData'))
##
## Diagnostic plots
pdff('mcsummary_parttrain')
