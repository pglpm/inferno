...
xsamples1 <- rxfromy(nsamples2, ysamples1)
nsamples2 <- 750
...
oalldata <- alldata#[c(rbind(1:nsamples1,(nsamples1+1):(nsamples1+nsamples2)))]
...
xtest <- round(quantile(alldata$x, (1:3)/4)*2)/2
##
