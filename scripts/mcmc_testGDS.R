...
## Last-Updated: 2022-12-13T13:11:08+0100
#########################################
...
baseversion <- '_testGDS' # *** ## Base name of output directory
## datafile <- 'testdataS1.csv'#'ingrid_data_nogds6.csv' #***
datafile <- 'ingrid_data_nogds6.csv' #***
predictorfile <- 'predictorsGDS.csv'
predictandfile <- 'predictorsGDS.csv'
varinfofile <- 'varinfoGDS.rds'
