...
metadatafile <- "../test_applications/metadata_nnom.csv"
##
set.seed(16)
ntrain <- 100
## ## plot prior first
...
## startparallel(4)
## ##
## outputdir <- file.path('..', 'test_applications', '_resnet_nnom_prior')
## mcoutput <- inferpopulation(data = NULL,
...
startparallel(4)
##
outputdir <- file.path('..', 'test_applications', '_resnet_nnom')
...
pdff(file.path(outputdir, 'nnom_posterior'))
