...
## starting worker pid=18222 on localhost:11257 at 15:40:10.382
## starting worker pid=18223 on localhost:11257 at 15:40:10.382
## starting worker pid=18224 on localhost:11257 at 15:40:10.382
## starting worker pid=18225 on localhost:11257 at 15:40:10.382
## 
## Using already registered doParallelSNOW with 4 workers
## Warning: data file has additional variates. Dropping them.
## Calculating auxiliary metadata
## Data file has additional variates. Dropping them.
## 
##  **************************************** 
##  Saving output in directory
##  _testexampledata2_Had-V7-D100-K64-S1200/ 
##  **************************************** 
## Starting Monte Carlo sampling of 1200 samples by 120
## in a space of 1151 (effectively 46341) dimensions.
## Using 4 cores: 10 samples per chain, 30 chains per core.
...
## 
## Max number of occupied clusters: 1 
## Plotting marginal samples.
## Plotting marginal samples with quantiles.
## 
...
## Using already registered doParallelSNOW with 4 workers
## Warning message:
## In samplesFDistribution(Y = Y, X = X, mcoutput = outputdir, parallel = TRUE) :
...
##           1 
## 
## Gain per sample: 0.46 
## Softmax gain per sample: 0.48 
## 
## Surprise per sample: 0.5437409 
## Softmax surprise per sample: 0.3908263 

## Loading required package: iterators
## Loading required package: parallel
## Loading required package: rngtools
## starting worker pid=19100 on localhost:11103 at 15:54:24.068
## starting worker pid=19101 on localhost:11103 at 15:54:24.068
## starting worker pid=19102 on localhost:11103 at 15:54:24.068
## starting worker pid=19099 on localhost:11103 at 15:54:24.068
## 
## Using already registered doParallelSNOW with 4 workers
## Warning: data file has additional variates. Dropping them.
## Calculating auxiliary metadata
...
##  ***************************************** 
##  Saving output in directory
##  _testexampledata2_flat-V7-D100-K64-S1200/ 
##  ***************************************** 
## Starting Monte Carlo sampling of 1200 samples by 120 chains
## in a space of 1151 (effectively 46341) dimensions.
## Using 4 cores: 10 samples per chain, 30 chains per core.
## Core logs are being saved in individual files.
## 
...
##           1 
## 
## Gain per sample: 0.34 
## Softmax gain per sample: 0.48 
## 
## Surprise per sample: 0.5828661 
## Softmax surprise per sample: 0.3908263 

## Loading required package: iterators
## Loading required package: parallel
## Loading required package: rngtools
## starting worker pid=20222 on localhost:11880 at 17:13:17.096
## starting worker pid=20220 on localhost:11880 at 17:13:17.096
## starting worker pid=20219 on localhost:11880 at 17:13:17.096
## starting worker pid=20221 on localhost:11880 at 17:13:17.096
## 
## Using already registered doParallelSNOW with 4 workers
## Warning: data file has additional variates. Dropping them.
## Calculating auxiliary metadata
...
##  **************************************** 
##  Saving output in directory
##  _testexampledata2_Jef-V7-D100-K64-S1200/ 
##  **************************************** 
## Starting Monte Carlo sampling of 1200 samples by 120 chains
## in a space of 1151 (effectively 46341) dimensions.
## Using 4 cores: 10 samples per chain, 30 chains per core.
...
##           1 
## 
## Gain per sample: 0.47 
## Softmax gain per sample: 0.48 
## 
## Surprise per sample: 0.5564149 
## Softmax surprise per sample: 0.3908263 
