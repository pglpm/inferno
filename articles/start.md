...
Its minimal arguments are three: the sample `data`, the `metadata`, and
...
[`learn()`](https://pglpm.github.io/prova/reference/learn.md) on 4 cores
– *please wait before running this code*, it might take longer time on
your computer:
...
took around 3 GB and 10 minutes to complete on 4 cores.
...
[`learnt10.rds`](https://github.com/pglpm/prova/raw/main/development/downloads/learnt10.rds).
...
each species. We can plot the probabilities of the frequencies of the
`Adelie` species only, as follows:
...
The [`hist()`](https://rdrr.io/r/graphics/hist.html) function plots the
probability distribution for all the frequency values; its `subset =`
argument selects the information pertaining only to the `Adelie`
species. We see that frequencies between around 0.2 and 0.4 have highest
probability. But the probability distribution is quite wide; even a
frequency of 0.6 has some probability. The vertical line indicates the
mean of this probability distribution, which we take as our frequency
estimate and as the probability that the next penguin we observe is of
the Adélie species.
...
# width: 4.27e-09 to 3.13e-07
# Plotting final Monte Carlo traces and marginal samples...
# 
# Total computation time: 9.3 mins 
# Average preparation & finalization time: 1.5 mins 
# Average Monte Carlo time per chain: 2.4 mins 
# Max total memory used: approx 3300 MB
...
file
[`learnt60.rds`](https://github.com/pglpm/prova/raw/main/development/downloads/learnt60.rds).
