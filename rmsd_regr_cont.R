...
## Last-Updated: 2021-07-04T12:55:23+0200
################
...
## #
## system.time(testmc <- profRegr(excludeY=FALSE, yModel='Categorical', xModel='Mixed', nSweeps=500, nBurn=100, nFilter=5, data=datamc, nClusInit=10, outcome='bin_RMSD', covNames=c(discreteCovs,continuousCovs), discreteCovs=discreteCovs, continuousCovs=continuousCovs, nProgress=100, seed=222, output='_mcoutput'))
## #
## pdff('cmsum_y_discr')
...
##
system.time(testmc <- profRegr(excludeY=TRUE, xModel='Mixed', nSweeps=1e4, nBurn=1e4, nFilter=10, data=as.data.frame(datamc), nClusInit=2, covNames=c(discreteCovs,continuousCovs), discreteCovs=discreteCovs, continuousCovs=continuousCovs, nProgress=100, seed=333, output='_mc2output', sampler='Truncated'))
##
