...
%% Last-Updated: 2021-06-16T15:57:46+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\propertitle}{Notes on root-mean-square-distance inference%\\{\large ***}%
...
\section{Overview of the inference}
\label{sec:overview}

Root-mean-square-distance class: $c$. Tuple of features: $x$. We have a set
$\set{c_{i}, x_{i} \mid i\in\set{1,2,\dotsc}}$ of known $(c,x)$ pairs. Our
inference is about the class $c_{0}$ of a new observation with features $x_{0}$:
\begin{equation}
  \label{eq:main_inference}
  \pf(c_{0} \| x_{0},\ \set{c_{i},x_{i}}) \ .
\end{equation}

One way to approach this is to assume that long-run frequencies of classes
and features, if known, would be sufficient to quantify the probability.
This is an exchangeability assumption.
