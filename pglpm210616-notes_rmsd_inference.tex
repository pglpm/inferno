...
%% Last-Updated: 2021-07-06T14:36:41+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\begin{equation}
  ...
  \begin{gathered}
  \p(x_{0} \| y_{0},\ \wy,\wx,\ H) =
\int F_{x_{0}\|y_{0}} \ \p(\yF_{\bm{x\mid}y_{0}} \| \wx,\ H)\ \di\yF_{\bm{x\mid}y_{0}}
  \\[\jot]
  \p(\yF_{\bm{x\mid}y_{0}} \| \wx,\ H) =
  \frac{
    \ F_{x_{1'}\| y_{0}} \  \dotsm \ 
  F_{x_{N'}\| y_{0}} \ \p(\yF_{\bm{x\mid}y_{0}}  \| H)
  }{
    \int
    \ F_{x_{1'}\| y_{0}} \  \dotsm \ 
  F_{x_{N'}\| y_{0}} \ \p(\yF_{\bm{x\mid}y_{0}}  \| H)\ \di\yF_{\bm{x\mid}y_{0}} 
}\\[\jot]
  \text{for each } y_{0} \in
  \set{\text{\enquote*{good}},\, \text{\enquote*{inconclusive}},\,
    \text{\enquote*{bad}}}\ ,
\end{gathered}
\end{equation}
where the conditionals contain only $\wx$ values associated with that
specific $y_{0}$ value \mynote{(\wrench\ I'll find clearer notation and
  explanations)}.
