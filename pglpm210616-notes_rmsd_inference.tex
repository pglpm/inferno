...
%% Last-Updated: 2021-07-04T21:36:59+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
known and yet unknown datapoints is irrelevant for new inferences. It has
the following important consequence. If we knew the infinite-limit long-run
relative frequencies of the values of past and future datapoints,
then the probability of observing a new value would be equal to the
long-run relative frequency of that value, for symmetry reasons.
