...
%% Last-Updated: 2021-08-20T15:58:20+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\mynote{\wrench Validation plan:
  ...
  • Set sampled from the original dataset. This represents a real case in
  ...
  different from those appearing in the original one. This represent a real
  case in which the conditional frequencies $F_{x\mid r}$ are expected to
  be as in our dataset, but the frequencies of the different $r$
  values and the conditional frequencies $F_{r\mid x}$ are expected to be
  different.
