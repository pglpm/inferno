...
%% Last-Updated: 2021-07-05T10:12:27+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\eqn~\eqref{eq:prob_cond_freq} holds, but not \eqn~\eqref{eq:prob_freq}.
...
$N$ of known data is small \mynote{\wrench\ add refs}. Many machine-learning
algorithms, such as deep nets, manage to deal with larger dimensionality
and datapoints by finding an argument that maximizes the integrands above
\parencites{mackay1992,mackay1992b}, for example a value of $y_{0}$ that
locally maximizes the integrand in the numerator of
\eqn~\eqref{eq:main_prob_exch}. This means, though, that they lose the
