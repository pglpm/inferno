...
%% Last-Updated: 2021-08-08T13:16:37+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
e\sect~\ref{sec:prob_longrun} give us probabilities for these long-run
...
\item $H_{\textrm{I}}$ and $H_{\textrm{ii}}$.
  % Combining
...
\item $H_{\textrm{I}}$ and $H_{\textrm{iii}}$. % Combining
  % \eqns~\eqref{eq:p_F_unfactorizable}, \eqref{eq:post_prob_F},
...
\item $H_{\textrm{I}}$ and $H_{\textrm{i}}$. Considering
...
\item $H_{\textrm{II}}$ and $H_{\textrm{i}}$. Considering
