...
%% Last-Updated: 2021-08-05T10:33:06+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
$r \in \set{\text{\enquote*{good}},\, \text{\enquote*{inconclusive}},\,
  \text{\enquote*{bad}}}$, corresponding to ${}<2\ \textrm{\AA}$, between
$2$ and $3\ \textrm{\AA}$, and ${}>3\ \textrm{\AA}$.
...
The first question we must ask in approaching this problem is this: How much
does our uncertainty about $r_{0}$ depend on the relative frequencies for the
known datapoints $(\br,\bx)$? For example, if $r_{0}$ is hand-picked by
someone, then knowledge of the frequencies for $(\br,\bx)$ is irrelevant.
But even in such a case it might be that the reversed probability
$\p(x_{0} \| r_{0},\ \br,\bx,\ H)$ \emph{does} depend on the frequencies of
