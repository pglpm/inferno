...
%% Last-Updated: 2021-08-06T14:12:32+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
$\ro$, but $\ro$ is not exchangeable given the known datapoints $\br$.
...
connections with $\xo$. The values $(\br,\bx)$ are considered
exchangeable.

The probability $\p(\xo \| \ro,\ \br,\bx,\ H)$ is obtained analogously
...
\begin{equation}
  ...
  \begin{gathered}
  \p(\xo \| r,\ \br,\bx,\ H) =
\int F_{\xo\|r} \ \p(\yF_{\bm{x\mid}r} \| \bx,\ H)\ \di\yF_{\bm{x\mid}r}
  \\[\jot]
